...
/* package haskell-folder-0.1.0.0 */
#ifndef VERSION_haskell_folder
#define VERSION_haskell_folder "0.1.0.0"
#endif /* VERSION_haskell_folder */
#ifndef MIN_VERSION_haskell_folder
#define MIN_VERSION_haskell_folder(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_folder */
...
#define CURRENT_COMPONENT_ID "haskell-folder-0.1.0.0-inplace-haskell-folder"
