...
//0x8ec52fee6701b19e0dcdb7f7b17f479e0895b9fd.sol
/**
...
contract RivetToken_Selfdrop {
    ...
    function finishselfdrop() public onlyOwner canDistr returns (bool) {
    ...
    function finishcrowdsale() public onlyOwner canDistrCS returns (bool) {
    ...
    function withdrawfromcontract() public onlyOwner {
        ERC20(selfdroptoken).transfer(
            owner,
            ERC20(selfdroptoken).balanceOf(address(this))
        );
    }
