...
contract DGK {
    ...
    function addSignature(string digitalFingerprint, string signature) isOwner {
    ...
    function removeSignature(string digitalFingerprint) isOwner {
    ...
    function removeSdaContract() isOwner {
        selfdestruct(owner);
    }
}
