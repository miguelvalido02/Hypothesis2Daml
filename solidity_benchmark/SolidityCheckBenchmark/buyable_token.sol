...
//0x743abb3597c56c9a17fb319d75b294dac8d7c006.sol
///
...
contract TokenERC20 is SafeMath {
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        uint previousBalances = SafeMath.safeAdd(
            balanceOf[_from],
            balanceOf[_to]
        );
        ...
        uint currentBalances = SafeMath.safeAdd(
            balanceOf[_from],
            balanceOf[_to]
        );
...
contract AdvancedToken is owned, TokenERC20 {
    ...
    constructor() public TokenERC20(linitialSupply, ltokenName, ltokenSymbol) {}
