 ...
 constructor ( string memory _name, string memory _symbol, string memory _tokenURI, uint256 _currentPrice, uint256 _prefix ) ERC721Mintable() ERC721Full(_name, _symbol) public {
 ...
 function keyMint( address _to, uint256 _amount) private {
 uint256 tokenId = 0;
 ...
 function keyExchange( uint256 _tokenId) public {
 burn(_tokenId);
 emit KeyExchange(msg.sender, _tokenId);
 }
 function keyExchangeMultiple( uint256[] memory _tokenId) public {
