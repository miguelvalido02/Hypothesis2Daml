...
//0x18f7958ad22a9ba68771f3daed3506e1b5a91e1d
contract DSMath {
...
contract OwnsArtRush is DSMath, Bank {
    ...
    function maxResalePrice() public view returns (uint) {
        return
            add(
                add(
                    rdiv(mul(price, maxPercentIncreaseAmount), 100 * RAY),
                    price
                ),
                maxFlatIncreaseAmount
            );
    }
}
